...
class Help(commands.MinimalHelpCommand):
    ...
    def get_opening_note(self):
        ...
        return f"Use `{self.clean_prefix}{command_name} <command/category>` for more info on any command or category"

    def get_ending_note(self):
        # return f"For more help join the support guild via: `{self.clean_prefix}support`"
        return "THIS IS A PLACEHOLDER HELP COMMAND I WILL ADD A PRETTY ONE IN FUTURE"
